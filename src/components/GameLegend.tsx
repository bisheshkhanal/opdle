...
export function GameLegend() {
  ...
  return (
    <div className="game-card legend-card sticky top-6 p-6">
      {/* Mobile toggle */}
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="flex w-full items-center justify-between font-pirate text-lg tracking-wide text-navy-700 dark:text-slate-200 lg:hidden"
      ...
      <div
        id="legend-content"
        className={`${isOpen ? "mt-6 block" : "hidden"} lg:mt-0 lg:block`}
      >
